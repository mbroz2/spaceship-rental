...
This application builds on step-04 with an example of using the Agent2Agent (A2A) protocol.
...
6. Use Agent2Agent (A2A) protocol to get the space weather.  Ask:
  - What's the space weather like around Jupiter?
  - What's the forecast for the Mars region?
